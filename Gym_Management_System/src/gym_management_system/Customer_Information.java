...
public class Customer_Information extends JFrame implements ActionListener {
    String x[] ={"Customer Id","Name","Last name","Email","Address","Contact no","Payment Plan","Gender","Height","Weight","Remarks","Trainer name","catg."};
    JButton bt;
    JPanel p1,p2,p3;
    JLabel l1,l2;
    JTextField tf1;
    ...
    Customer_Information()
    {
        ...
        l1= new JLabel("Delete Customer By ID ");
        l1.setHorizontalAlignment(JLabel.CENTER);
        l1.setFont(f1); l1.setForeground(Color.ORANGE);
        
        l2= new JLabel("Customer ID");
        l2.setFont(f1); l2.setForeground(Color.CYAN);
        ...
        tf1.setFont(f); bt.setFont(f);

        bt.addActionListener(this);
        bt.setBackground(Color.RED); bt.setForeground(Color.BLACK);
              
        p2= new JPanel();
        p2.setLayout(new GridLayout(1,3,10,10));
        p2.add(l2); p2.add(tf1); p2.add(bt);
