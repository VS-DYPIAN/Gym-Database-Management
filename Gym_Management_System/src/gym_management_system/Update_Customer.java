...
public class Update_Customer extends JFrame implements ActionListener
{
    ...
    Update_Customer()
    {
        ...
        f1=new Font("Laventa",Font.BOLD,25);
        f=new Font("Laventa",Font.BOLD,18);
        ...
        tf3=new JTextField(); tf4=new JTextField();
        tf5=new JTextField(); tf8=new JTextField();
        tf9=new JTextField(); tf10=new JTextField();
        
        ch1=new Choice(); ch2=new Choice(); ch3=new Choice(); 
        ch5=new Choice(); ch6=new Choice();
        ...
        ch1.add("Personal"); ch1.add("Public");
        
        ch2.add("1"); ch2.add("3");
        ch2.add("6"); ch2.add("12");
        
        ch3.add("Male"); ch3.add("Female");
        
        bt1=new JButton("Update"); bt2=new JButton("Cancel");
        
        bt1.setBackground(Color.YELLOW); bt1.setForeground(Color.BLACK);
        bt2.setBackground(Color.RED); bt2.setForeground(Color.BLACK);
        
        bt1.addActionListener(this);
        bt2.addActionListener(this);
        
        l1.setFont(f); l2.setFont(f); l3.setFont(f);
        l4.setFont(f); l5.setFont(f); l7.setFont(f);
        l8.setFont(f); l9.setFont(f); l10.setFont(f);
        l11.setFont(f); l12.setFont(f); l13.setFont(f);
        l16.setFont(f); l17.setFont(f);
        
        tf1.setFont(f); tf2.setFont(f); tf3.setFont(f);
        tf4.setFont(f); tf5.setFont(f); tf8.setFont(f);
        tf9.setFont(f); tf10.setFont(f);
        
        ch1.setFont(f); ch2.setFont(f); ch3.setFont(f);
        ch5.setFont(f); ch6.setFont(f);
        
        bt1.setFont(f); bt2.setFont(f);
        
        bt3=new JButton("Public"); bt4=new JButton("Personal");
        
        bt3.setBackground(Color.gray); bt3.setForeground(Color.WHITE);
        bt4.setBackground(Color.gray); bt4.setForeground(Color.WHITE);
        ...
        p1.add(l8); p1.add(ch6); p1.add(l1);
        p1.add(tf1); p1.add(l2); p1.add(tf2);
        p1.add(l3); p1.add(tf3); p1.add(l4);
        p1.add(tf4); p1.add(l5); p1.add(tf5);            
        p1.add(l9); p1.add(ch2); p1.add(l10);
        p1.add(ch3); p1.add(l11); p1.add(tf8);
        p1.add(l12); p1.add(tf9); p1.add(l13);
        p1.add(tf10); p1.add(bt3); p1.add(bt4);
        p1.add(l7); p1.add(ch1); p1.add(l17);
        p1.add(ch5);
        ...
        p2.setBackground(Color.BLACK); p2.add(l14);
        
        p3=new JPanel();
        p3.setLayout(new GridLayout(1,1,10,10));
        p3.setBackground(Color.BLACK); p3.add(l15);
        
        l1.setForeground(Color.WHITE); l2.setForeground(Color.WHITE);
        l3.setForeground(Color.WHITE); l4.setForeground(Color.WHITE);
        l5.setForeground(Color.WHITE); l7.setForeground(Color.WHITE);
        l8.setForeground(Color.WHITE); l9.setForeground(Color.WHITE);
        l10.setForeground(Color.WHITE); l11.setForeground(Color.WHITE);
        l12.setForeground(Color.WHITE); l13.setForeground(Color.WHITE);
        l16.setForeground(Color.WHITE); l17.setForeground(Color.WHITE);
        
        setLayout(new BorderLayout(0,0));
        
        add(p2,"North"); add(p3,"West"); add(p1,"Center");
